...
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-control-mapping-regulation-clause/run.

export default function AiControlMappingRegulationClausePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-control-mapping-regulation-clause/run', {
        method: 'POST',
        headers: {
